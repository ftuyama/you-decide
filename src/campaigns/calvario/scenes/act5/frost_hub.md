...
onEnter: []
---
Uma **lasca** de abrigo contra o vento: tendas que rangem como **dentes** velhos, fogareiro que mais **ameaça** do que aquece.

Aqui o mapa é **decisão** — não linha. Podes seguir o rumor, **negociar** o preço do calor, ou deixar a neve **escolher** por ti.
